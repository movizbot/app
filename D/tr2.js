...
Telegram.WebApp.ready(); 
      await lditemsdebug();   
      Telegram.WebApp.themeParams.text_color= '#ededed';
...
function Showapp(e)
{
    ...
    msg="Download Movie Coin Android app to earn 100,000 $Moviz each time you watch an ad.";
      ...
      link2open=st;closeapp=true;
         ...
         savedebug();
          ...
          { 
            ...
            Telegram.WebApp.openTelegramLink('https://t.me/share/url?url='+uu.refId+'&text=You are invited to join Movie Coin today.');
            return;
          }      
  else 
          { 
